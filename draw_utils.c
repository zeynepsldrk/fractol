...
/*   Updated: 2025/10/14 13:13:06 by zedurak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_color(int iteration, int max_iter)
{
	...
	if (iteration >= max_iter)
		return (0x000000);
	colors.color[0] = 0xFF7F50;
	colors.color[1] = 0x3CB371;
	colors.color[2] = 0x4169E1;
	colors.color[3] = 0xFF8C00;
	colors.color[4] = 0xDB7093;
	colors.color[5] = 0xBA55D3;
	colors.color[6] = 0x20B2AA;
	colors.color[7] = 0xDAA520;
	color_index = iteration % 8;
